 ...
 */
function generateHeadline(companyPe: number | undefined, sectorStats?: SectorStats): string {
 ...
 */
function generatePeContext(companyPe: number | undefined, sectorStats?: SectorStats): string {
	if (companyPe === undefined) {
