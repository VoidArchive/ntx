...
>
	...
	<div class="flex items-start justify-between">
		...
		<span
			class="inline-flex shrink-0 items-center rounded-full border border-border bg-background/50 px-2 py-0.5 text-[10px] font-medium tracking-wider whitespace-nowrap text-muted-foreground uppercase"
		>
